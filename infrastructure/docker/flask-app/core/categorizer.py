...
from config.categories import CATEGORIES, BREAKING_CATEGORIES
...
class PressReleaseCategorizer:
    ...
    # Import categories from single source of truth
    ...
    def categorize_press_release(self, press_release):
        ...
        # Build the prompt
        prompt = f"""You are analyzing a REIT (Real Estate Investment Trust) press release. 

Categories (in priority order):
1. M&A - Mergers, acquisitions, company sales
2. Property Transactions and Leases - Property acquisitions, dispositions, development, leasing
