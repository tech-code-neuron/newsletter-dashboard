"""
Newsletter generation for REIT press releases
"""
...
class NewsletterGenerator:
    ...
    CATEGORY_ORDER = [
        ...
        ('Property Transactions and Leases', 'Property Transactions and Leases'),
    ...
    # Theme configurations (SOLID compliant: uses design tokens)
    THEMES = {
        'morning': {
            'primary_color': get_color('primary'),
            'heading_color': get_color('text_dark'),
            'title': 'REIT Morning Brief',
            'badge': None,
        ...
        'breaking': {
            'primary_color': get_color('danger'),
            'heading_color': get_color('danger'),
            'title': 'Breaking REIT News',
            'badge': '9:00 AM Brief',
...
"""
        ...
        html += f"""
        <div class="footer">
            REIT Newsletter • Generated {datetime.now().strftime('%B %d, %Y at %I:%M %p ET')}
        </div>
    </div>
</body>
</html>
"""
    ...
    def create_newsletter(self, newsletter_type='morning', date=None):
        ...
        if newsletter_type == 'morning':
            ...
            subject = f"REIT Morning Brief - {date.strftime('%B %d, %Y')}"
            ...
            subject = f"Breaking REIT News - {date.strftime('%B %d, %Y')}"
