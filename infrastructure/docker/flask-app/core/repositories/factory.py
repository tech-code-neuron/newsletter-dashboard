...
@lru_cache(maxsize=1)
def get_disclosure_repo():
    """Get 8-K disclosure repository (DynamoDB)"""
    from core.repositories.dynamodb_backend import DynamoDBDisclosureRepository
    return DynamoDBDisclosureRepository()
