...
def _ensure_initialized():
    ...
    global _initialized, _config, _tables
    ...
    _config['REIT_NEWS_TABLE'] = os.environ.get('REIT_NEWS_TABLE', 'reitsheet-reit-news')
    _config['URL_CACHE_TABLE'] = os.environ.get('URL_CACHE_TABLE', 'reitsheet-url-cache')
    ...
    _tables['url_cache'] = dynamodb.Table(_config['URL_CACHE_TABLE'])

    # Initialize persistence module with tables
    initialize_tables(_tables['reit_news'], _tables['url_cache'])
