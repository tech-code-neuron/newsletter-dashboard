...
CONFIRMATION_KEYWORDS = [
    ...
    # Non-press-release Q4 alert types (supplemental reports, not PRs)
    'has added a new financial report',    # Q4 Inc financial report emails
]

# ============================================================================
# Activation/Verification Email Keywords (SSOT)
# ============================================================================
# Purpose: Filter out subscription activation/verification emails
# Used by: parser (is_confirmation_email)
# Copied from integrations/gmail/filters.py (production-proven patterns)
#
# SAFETY: These are EXACT PHRASES that only appear in activation emails.
# Verified: 0 out of 65 press releases in DB contain "activat" in title.
# Single words like "activation" could theoretically match a PR like
# "Company Announces Activation of New Property" but no such PRs exist.

ACTIVATION_KEYWORDS = [
    # Exact phrases from subscription emails (SAFEST - very specific)
    'validate account',
    'confirm your email alert subscriptions',
    'signup confirmation',
    ...
    'verify your request',
    'verify your email',      # Exact phrase "verify your email" not just "verify"
    'confirm your email',     # Exact phrase "confirm your email" not just "confirm"
]
