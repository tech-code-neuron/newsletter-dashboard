...
# Social media pipeline queues
SOCIAL_CLASSIFY_QUEUE = f"{PROJECT_NAME}-social-classify-queue"
SOCIAL_POSTING_QUEUE = f"{PROJECT_NAME}-social-posting-queue"
...
SOCIAL_CLASSIFY_DLQ = f"{PROJECT_NAME}-social-classify-dlq"
SOCIAL_POSTING_DLQ = f"{PROJECT_NAME}-social-posting-dlq"
...
QUEUE_NAMES = {
    ...
    'social_classify': SOCIAL_CLASSIFY_QUEUE,
    'social_posting': SOCIAL_POSTING_QUEUE,
    'parse_dlq': PARSE_DLQ,
    'enrich_dlq': ENRICH_DLQ,
    'scrape_dlq': SCRAPE_DLQ,
    'playwright_dlq': PLAYWRIGHT_DLQ,
    'simple_scraper_dlq': SIMPLE_SCRAPER_DLQ,
    'social_classify_dlq': SOCIAL_CLASSIFY_DLQ,
    'social_posting_dlq': SOCIAL_POSTING_DLQ,
}
